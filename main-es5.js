...
/* harmony import */ var ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-bootstrap/timepicker */ "./node_modules/ngx-bootstrap/timepicker/fesm5/ngx-bootstrap-timepicker.js");
/* harmony import */ var ngx_bootstrap_rating__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngx-bootstrap/rating */ "./node_modules/ngx-bootstrap/rating/fesm5/ngx-bootstrap-rating.js");
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getSubscriptionTypes = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(['Monthly', 'Annual', 'Lifetime']);
    };
    DataService.prototype.postUserSettingsForm = function (userSettings) {
...
var UserSettingsFormComponent = /** @class */ (function () {
    function UserSettingsFormComponent(dataService) {
        ...
        this.userSettings = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.originalUserSettings);
    ...
    UserSettingsFormComponent.prototype.ngOnInit = function () {
        this.subscriptionTypes = this.dataService.getSubscriptionTypes();
        this.startDate = new Date();
        this.startTime = new Date();
    };
    UserSettingsFormComponent.prototype.onSubmit = function (form) {
        var _this = this;
        console.log('in on Submit', form.value);
        if (form.valid) {
            this.dataService.postUserSettingsForm(this.userSettings).subscribe(function (result) {
    ...
    UserSettingsFormComponent.prototype.onHttpError = function (errorResponse) {
        console.log('error', errorResponse);
        this.postError = true;
        this.postErrorMessage = errorResponse.error.ErrorMessage;
    };
    UserSettingsFormComponent.prototype.onBlur = function (field) {
        console.log('in on Blur', field.valid);
    };
    UserSettingsFormComponent.ctorParameters = function () { return [
    ...
    return UserSettingsFormComponent;
}());
